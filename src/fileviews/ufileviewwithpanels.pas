...
uses
  ...
  math, uTypes, uFileFunctions, LCLType,
  uFileView,
  uFileViewHeader,
  uFileSource;
...
type
  ...
  TStatusPanel = class(TCustomControl)  //cryham
  public
...
begin
  ...
  // pnlFooter.Height := 2 * pnlFooter.Canvas.TextHeight('Wg') +2;  //todo?
end;
...
begin
  ...
  pnlFooter            := TStatusPanel.Create(Self);  //cryham
  ...
  {$ELSE}
  pnlFooter.Height := 2 * pnlFooter.Canvas.TextHeight('Wg') +2;
  {$ENDIF}
