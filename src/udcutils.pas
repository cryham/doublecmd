...
function cnvFormatFileSize(const iSize: int64; FSF: TFileSizeFormat; const Number: integer): string;
const
  DIVISORS: array[LOW(TFileSizeFormat) .. HIGH(TFileSizeFormat)] of uint64 = (1, 1,  //1024  //cryham
    1000, (1000*1000), (1000*1000*1000), (1000*1000*1000*1000), 1, 1, 1000, (1000*1000), (1000*1000*1000), (1000*1000*1000*1000));
var
  FloatSize: extended;
begin
  FloatSize := iSize;
